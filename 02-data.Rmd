...
In order to obtain the real-life batting statistics for each individual player, we choose to scrape the Standard Batting table on the Baseball Reference website for each individual player. For example, the batting stats for Derek Jeter can be found at [this link](https://www.baseball-reference.com/players/j/jeterde01.shtml). Since we only want data from 1998 season, the row of Year 1998 in the Standard Batting table is our target.

![](data/screenshot/jeterde01_batting.png)

The entire list of players can be found in the [folder](https://github.com/zichenghuang/baseball-board-game/tree/main/data/players_list). 
