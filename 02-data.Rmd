...
In order to extract the data we need from [Baseball Reference](https://www.baseball-reference.com), we will perform web scraping to pull the batting and pitching data in year 1998 for the players that appear in the 100 games of APBA Baseball.
...
We can scrape the data from Year 1998 row of the Standard Batting table on the website for each individual player. For example, the batting for Derek Jeter can be found at https://www.baseball-reference.com/players/j/jeterde01.shtml. The entire list of players can be found in the ![folder](data/players_list/). 

```{r, eval=FALSE}

## obtain batting data for players only do batting
...
## obtain batting data for players do both batting and pitching
